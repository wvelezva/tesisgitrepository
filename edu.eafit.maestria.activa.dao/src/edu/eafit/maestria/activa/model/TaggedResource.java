...
@SequenceGenerator(name = SequenceName.TAGGED_RESOURCE_ID, sequenceName = SequenceName.TAGGED_RESOURCE_ID, allocationSize = 1)
public class TaggedResource implements ITaggedResource
{
	...
	public TaggedResource(IResourceTag tag, Resource resource)
	{
		this.tag = tag;
		this.resource = resource;
	}
	
	public TaggedResource(IResourceTag tag, Resource resource, IEntity entity)
	{
		this.tag = tag;
		this.resource = resource;
		this.entity = entity;
	...
	@Id
	@GeneratedValue(generator = SequenceName.TAGGED_RESOURCE_ID, strategy = GenerationType.SEQUENCE)
