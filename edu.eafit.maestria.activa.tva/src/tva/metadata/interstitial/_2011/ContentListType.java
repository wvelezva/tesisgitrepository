 ...
 *       &lt;sequence>
 *         &lt;element name="Item" type="{urn:tva:metadata:interstitial:2011}ContentRefType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "ContentListType", propOrder = {
    "item"
})
public class ContentListType {

    @XmlElement(name = "Item", required = true)
    protected List<ContentRefType> item;
     ...
     * 
     */
    public List<ContentRefType> getItem() {
        if (item == null) {
            item = new ArrayList<ContentRefType>();
        }
        return this.item;
    }
